...
import './Table.scss';
import { CustomerRequestProps } from '../../../hooks/UseCustomerMasterMutatedData';

export interface ICustomerMasterBulkRegistrationTableProps
  extends CustomerRequestProps {
  id: string;
}

export const CustomerMasterBulkRegistrationTable = React.forwardRef(
  (
    {
      tableData,
      setSelectedRows,
...
export default CustomerMasterBulkRegistrationTable;
