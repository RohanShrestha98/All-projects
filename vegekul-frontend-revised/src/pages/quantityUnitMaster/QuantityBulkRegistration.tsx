...
import { useQuantityUnitBulkRegistration } from '../../hooks/useQuantityUnitMutation';
import { QuantityUnitBulkRegistrationHeaders } from '../../components/table/headers/QuantityUnitBulkRegistration';
import { FiUpload } from 'react-icons/fi';
import { useNavigate } from 'react-router-dom';

const columnHelper = createColumnHelper<any>();

function QuantityrBulkRegistration({ t }: { t: TFunction }) {
  ...
  const quantityrBulkRegistrationMutation = useQuantityUnitBulkRegistration();
  ...
  const handleRegistrationClick = () => {
    ...
    if (exportedData) {
      ...
      quantityrBulkRegistrationMutation
        .mutateAsync(['post', 'quantity-unit/import/', finalData])
        .then(response => {
          toast.success(
            'Quantity Unit Registration data uploaded successfully'
          );
          navigate('/quantity-unit-master');
  ...
  const handleFileUpload = (data: any) => {
    ...
    if (headers) {
      setTableDataFromCSV(
        ...
        headers,
        QuantityUnitBulkRegistrationHeaders
      );
    } else {
    }
  };
  ...
  return (
    <div className="rightSidePart">
      <Navbar pagetitle={t('quantityBulkRegistration')} />
...
export default withTranslation()(QuantityrBulkRegistration);
