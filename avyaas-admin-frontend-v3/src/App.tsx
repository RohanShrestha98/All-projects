      ...
      <Routes>
        ...
        </Route>
        {
          user && <Route element={<BaseLayout />}>
            ...
            <Route path='/question-bank/question' element={<AddQuestionInQuestionBank />} />
            <Route path='/question-bank/preview-questions' element={<PreviewQuestionBank />} />
          </Route>
        }
