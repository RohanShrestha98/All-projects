                    ...
                    <SortableList
                        ...
                        renderItem={(item, index) => (
                            <SortableList.Item id={item?.id}>
                                <tr key={item?.id} className=' w-full flex bg-white justify-between items-center h-10'>
                                    <td className=' w-[5%] text-center'>{index + 1}</td>
                                    <div className='w-2/6 '>
                                        <SortableList.DragHandle >
                                            <div className="flex items-center gap-1">
                                                {
                                                    item?.thumbnail ? <img className="h-8 w-8 object-cover rounded-full" src={item?.thumbnail} alt="" />
                                    ...
                                    <td className=' w-1/6'>{truncateText(item?.description, 40)}</td>
                                    <div className="flex gap-2 w-1/6 text-base justify-center">
                                        ...
                                        <DeleteModal asChild desc={"Are you sure you want to delete this unit"} title={"Delete Unit"} id={item}>
