...
>(({ className, isToggle, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block ml-[2px]  bg-gray-300 data-[state=checked]:border-[#4365A7] data-[state=checked]:bg-white border h-5 w-5 rounded-full  shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0", isToggle ? "h-4 w-4 ml-[1px] data-[state=checked]:translate-x-4" : ""
      )}
    />
  </SwitchPrimitives.Root>
))
