...
import { useCourseData, useSubjectData, useTeacherData } from "@/hooks/useQueryData";
...
export default function Instructor() {
    ...
    const { data, isLoading, isError } = useTeacherData(searchText, selectedField, pageSize, page, selectedSubject)
                ...
                cell: (info) => {
                    return (
                        <div className="flex gap-2 text-base justify-center">
                            ...
                            <DeleteModal asChild desc={"Are you sure you want to delete this instructor"} title={"Delete Instructor"} id={info?.row?.original?.id}>
    ...
    return (
        <div className="p-4 flex flex-col gap-4">
            <div className="flex justify-between items-center">
                <FilterSearch searchText={searchText} setSelectedField={setSelectedField} setSelectedSubject={setSelectedSubject} options={courseOptions} subjectOptions={subjectOptions} inputPlaceholder={"Search Instructor"} setSearchText={setSearchText} selectPlaceholder={"Select Course"} />
