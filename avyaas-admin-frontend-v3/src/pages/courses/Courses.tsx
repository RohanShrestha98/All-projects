                ...
                cell: (info) => {
                    return (
                        <div className="flex gap-2 text-base justify-center">
                            <Switch isToggle onClick={() => handleIsPublic(info?.row?.original?.id)} checked={info?.row?.original?.available} className="bg-gray-300" />
                            <AddCourseModal asChild edit editData={info?.row?.original}>
                                <FiEdit2 className="text-[#4365A7] cursor-pointer" />
                            </AddCourseModal>
                            <DeleteModal asChild desc={"Are you sure you want to delete this course"} title={"Delete Course"} id={info?.row?.original?.id}>
    ...
    return (
        <div className="p-4 flex flex-col gap-4">
            <div className="flex justify-between items-center">
                <FilterSearch searchText={searchText} setSelectedField={setSelectedField} options={courseGroupOptions} inputPlaceholder={"Search Courses"} setSearchText={setSearchText} selectPlaceholder={"Select Course Group"} />
