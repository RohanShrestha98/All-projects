...
export default function LiveGroup() {
    ...
    const { data, isLoading, isError } = useLiveGroupData(searchText, selectedField, pageSize, page)
                ...
                cell: (info) => {
                    return (
                        <div className="flex gap-2 text-base justify-center">
                            ...
                            <DeleteModal asChild desc={"Are you sure you want to delete this live group"} title={"Delete Live Group"} id={info?.row?.original?.id}>
    ...
    return (
        <div className="p-4 flex flex-col gap-4">
            <div className="flex justify-between items-center">
                <FilterSearch searchText={searchText} setSelectedField={setSelectedField} options={courseOptions} inputPlaceholder={"Search Live Group"} setSearchText={setSearchText} selectPlaceholder={"Select Course"} />
                <AddLiveGroupModal asChild>
                    <div>
                        <TopButton buttonName={"Add Live Group"} className={""} handleButtonClick={() => { }} />
                    </div>
                </AddLiveGroupModal>
            </div>
            <div>
