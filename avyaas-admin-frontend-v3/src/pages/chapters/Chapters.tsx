    ...
    <div className="p-4 flex flex-col gap-4">
      ...
      <div className="">
        ...
        <div className="grid grid-cols-2 bg-white">
          <div
            className={`border flex flex-col gap-2 p-2 ${selectedField && "bg-blue-50"
              }`}
          >
                    ...
                    renderItem={(item, index) => (
                      <SortableList.Item id={item?.id}>
                        <div
                          ...
                          className={`flex border  cursor-pointer justify-between items-center rounded-xl p-2 px-3 w-full ${item?.id === selectedChapter?.id ||
                            (!selectedChapter &&
                    ...
                    renderItem={(item, index) => (
                      <SortableList.Item id={item?.id}>
                        <div
                          ...
                          className={`flex border  cursor-pointer justify-between items-center rounded-xl p-2 px-3 w-full ${(item?.id === selectedContent?.id ||
                            (!selectedContent &&
                              item?.id === data?.data?.[0]?.id)) &&
                            "bg-blue-100"
                            }`}
