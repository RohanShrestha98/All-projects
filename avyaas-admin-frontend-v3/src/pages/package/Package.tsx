...
export default function Package() {
    ...
    const { data, isLoading, isError } = usePackageData(searchText, selectedField, pageSize, page)
                ...
                cell: (info) => {
                    return (
                        <div className="flex gap-2 text-base justify-center">
                            ...
                            <DeleteModal asChild desc={"Are you sure you want to delete this package"} title={"Delete Package"} id={info?.row?.original?.id}>
    ...
    return (
        <div className="p-4 flex flex-col gap-4">
            <div className="flex justify-between items-center">
                <FilterSearch searchText={searchText} setSelectedField={setSelectedField} options={courseOptions} inputPlaceholder={"Search package"} setSearchText={setSearchText} selectPlaceholder={"Select Course"} />
                <AddPackageModal asChild>
                    <div>
                        <TopButton buttonName={"Add Package"} className={""} handleButtonClick={() => { }} />
                    </div>
                </AddPackageModal>
            </div>
            <div>
