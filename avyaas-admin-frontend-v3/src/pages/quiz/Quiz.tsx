                ...
                data?.data?.map((item, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={` border flex flex-col gap-1 cursor-pointer rounded-xl  p-4 w-full ${(item?.id === selectedQuiz?.id ||
                        (!selectedQuiz &&
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 toggle">
                          <Switch isToggle onClick={() => handleIsPublic(item?.id)} checked={item?.isPublic} className="bg-gray-300" />
                          <p
                            className={`text-[12px] px-3 py-[2px] ${item?.isDraft
