...
export default function SubmittedAssignmentFromSection({ active, location }) {
  const [searchText, setSearchText] = useState("");
  const { data, isLoading, isError } = useQueryData(
    ["section-submitted-list", searchText],
    `api/v1/assignment/student-list/?status=submitted&&section=${
      location && location
    }&&query=${searchText}`,
  );
