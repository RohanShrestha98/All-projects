...
const HelpCenterTabs = ({initial, activeTab}) => {
  ...
  const items = [
    {
      key: "1",
      label: (
       <div className="px-4 py-1 flex items-center justify-center h-[38px] sm:w-[100px] w-40 ">
    ...
    {
      key: "2",
      label: (<div className="py-1 flex items-center justify-center w-40  sm:w-[100px] h-[38px] ">
 ...
 return(
  <div className="w-full help-center">
    {initial ? <div className="flex gap-x-2">
    <div><ShimmerBadge/></div>
    <div><ShimmerBadge/></div>
    </div> : <Tabs
