      ...
      <div className="flex justify-between w-[70%] mb-7 language-radio sm:w-full">
        ...
        {initial ? (
          ...
          <Radio
            ...
            onClick={() => handleClick(props.settings)}
          />
        )}{" "}
      </div>
    );
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex sm:block">
        ...
        <div className="w-[80%] mt-[43px] ml-20 sm:ml-0 sm:mt-0 sm:w-full">
          ...
          <div className="px-6 sm:mt-28">
            {!initial && (
              <div className="font-bold text-lg text-black-gray mb-9">
                Suggested
              </div>
            )}
            <EachSettings
              settings="English(US)"
              checked={checked === "English(US)" ? true : false}
            />
            <EachSettings
              settings="English(UK)"
              checked={checked === "English(UK)" ? true : false}
            />
            <EachSettings
              settings="English(Spanish)"
              checked={checked === "English(Spanish)" ? true : false}
            />
          </div>
        </div>
      </div>
